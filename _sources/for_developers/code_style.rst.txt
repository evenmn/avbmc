...
#. A doc string with the standard licence information, author and date last edited
#. A doc string about the tasks of the file/class
#. External includes (standard library, for instance)
#. Local includes (usually from AVBMC header files)
#. A doc string before every function, including the constructor and destructor
