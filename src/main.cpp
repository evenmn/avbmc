...
int main()
{
    ...
    //AVBMCMolIn move3(&system, &box, single_molecule, 3., 0.9, 4.0);
    //AVBMCMolOut move4(&system, &box, single_molecule, 4.0, 3.);
    ...
    box.write_size_histogram("nsystemsize_biased_water.txt");
    return 0;
}
